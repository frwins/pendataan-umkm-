...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-2" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">UMKM</a>
            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#page-top">Login</a></li>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">Selamat Datang di Pendataan UMKM BRANTAKSEKARJATI</h1>
                    <hr class="divider my-4" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 font-weight-light mb-5">Silahkan Untuk login terlebih dahulu </p>
                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="auth/login">Login Admin</a>
                    <br></br>
                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="auth2/login">Login Pengguna</a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-50 mb-1">~ Mendaftarkan dengan KTP (bagian menu login pengguna, dan buat akun)</p>
    ...
    <section class="page-section" id="Kontak">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="mt-0">Kontak Admin</h2>
                    <hr class="divider my-4" />
                    <p class="text-muted mb-5">Jika ada masukan, silahkan hubungi admin </p>
                </div>
            </div>
            <div class="row">
